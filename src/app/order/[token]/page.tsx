    ...
    <>
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8">
        ...
        <div className="mt-5 rounded-lg border border-border-subtle bg-surface p-4">
          <p className="text-sm text-muted-ink">Confirmation reference</p>
        ...
        <dl className="mt-4 space-y-2 text-sm">
          <div className="flex justify-between">
            <dt className="text-muted-ink">Subtotal</dt>
        ...
        <address className="mt-2 text-sm not-italic leading-relaxed text-muted-ink">
          {order.delivery.name}
          <br />
        ...
        <Link
          href="/search"
          className="mt-8 inline-block rounded-md bg-accent px-4 py-2 text-sm font-semibold text-accent-ink hover:brightness-110"
        >
          Continue shopping
        </Link>
      </main>
